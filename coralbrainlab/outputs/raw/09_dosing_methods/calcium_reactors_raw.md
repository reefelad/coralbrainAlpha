...
*   **Magnesium Chips:** Often mixed in (approx 10%) to maintain Magnesium levels alongside Ca/Alk.
...
Using a high-precision peristaltic pump (like Kamoer FX-STP or Ecotech Versa) to feed the reactor ensures a constant, unvarying effluent rate. This eliminates the common issue of needle valves clogging and flow rates drifting, making tuning purely a function of pH control.
...
- **Depressed Tank pH:** Calcium reactor effluent is acidic (pH ~6.7) and contains excess CO2. If not degassed (e.g., dripped into skimmer intake or refugium), it can chronically suppress system pH below 7.8.
...
⚠️ **TIER 2 DEFAULTS:**
- **Effluent Drip Location:** Always dose effluent into a high-flow area, ideally upstream of the protein skimmer or large macroalgae bed to drive off/consume excess CO2.
