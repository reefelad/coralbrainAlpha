...
Beyond sponges, cryptic zones host tunicates, tube worms, foraminifera, and copepods. This diversity creates a more resilient ecosystem ("monocultures are unstable"). These organisms act as natural living mechanical filters, trapping suspended silts and clarifying the water without the labor of changing filter socks.
...
*   **No Stagnation:** Water must move. Completely stagnant areas can facilitate hydrogen sulfide production if deep anaerobic pockets form without nitrate penetration. Ensure finding slow *flow*, not *no flow*.

⚠️ **TIER 2 DEFAULTS:**
*   **Darkness Compliance:** Ensure light spill from the refugium or skimmer does not reach the cryptic zone, or it will just become a dirty algae trap.
