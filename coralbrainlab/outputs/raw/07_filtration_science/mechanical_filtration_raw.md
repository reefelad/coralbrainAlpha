...
## Interfaces
- **Connects to:** [Nutrient Management], [Flow & Hydrodynamics] (to keep particles suspended).
- **Depends on:** [Flow Patterns] to ensure detritus reaches the overflow.
- **Informs:** [Protein Skimming] (removes larger solids skimmers might miss).
