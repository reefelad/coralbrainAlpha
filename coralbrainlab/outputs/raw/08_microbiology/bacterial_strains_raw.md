...
- **Probiotic Dosing**: Adding specific strains (often *Bacillus* spores) is believed to outcompete potential pathogens (like *Vibrio coralliilyticus*) through competitive exclusion [TIER-2].
...
- **"Old Tank Syndrome"**: Can fundamentally be a loss of biodiversity over time, leading to monocultures where one strain dominates, leaving the tank vulnerable to a crash or pathogen takeover. Periodic introduction of new genetic material (live rock rubble, sand from healthy tanks) can mitigate this [TIER-3].
