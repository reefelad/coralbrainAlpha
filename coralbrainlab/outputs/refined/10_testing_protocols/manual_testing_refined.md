...
**Lighting Matters:** Color changes (e.g., pink to blue) can be incredibly difficult to discern under heavy blue actinic reef lighting. Always perform titration tests under bright, naturally validated white light (approx. 6500K) or daylight to ensure the endpoint is correctly identified.
...
5.  **Dry** with a lint-free cloth or air dry upside down to prevent water spots or dilution of future samples.

### Handling and Storing Reagents
- **Vertical Drops:** Hold dropper bottles exactly vertical. An angled bottle produces smaller drops, artificially inflating the reading.
...
- **Storage:** Store all test kits in a cool, dry place away from direct sunlight and extreme temperatures (e.g., not under the aquarium cabinet if it gets hot/humid from the sump). Heat can rapidly degrade chemical reagents.
...
*\*Note: 0.018 mg/L is a precise calculation; generally targeting 0.02 - 0.08 mg/L is acceptable, with 0.04 mg/L often cited as ideal.*
...
- Use white light for reading colorimetric tests to avoid error.
...
- [VERIFY] The impact of ambient light color temperature on reading color-change titration kits (e.g., blue reef lighting vs. daylight CLI) - *Added recommendation for white light.*
...
**Critic Verdict:** PASS
**Issues Addressed:**
- **Lighting for Titration:** Added explicit instruction to use white light/daylight.
- **Reagent Storage:** Added section on cool/dry storage.
- **Phosphate Range:** Clarified the targets with a note.
- **Cleaning:** Added "Dry" step to protocol.
