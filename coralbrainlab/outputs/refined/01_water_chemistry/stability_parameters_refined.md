...
*   **Refugium (RDP):** Run macroalgae on a "Reverse Daylight Protocol" (lit at night) to consume CO2 when the main tank lights are off, preventing the nightly pH drop.
...
- Previous: [Trace Elements](trace_elements.md)
- Next: [Parameter Interactions](parameter_interactions.md)
...
- **Clarification:** Explained RDP (Reverse Daylight Protocol) role in pH stabilization specifically for night-time.
