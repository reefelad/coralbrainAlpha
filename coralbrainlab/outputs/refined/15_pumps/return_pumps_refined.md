...
## Interfaces
- **Connects to:** `14_tanks_plumbing/pipe_fittings` (return plumbing)
- **Connects to:** `13_system_design/plumbing_hydraulics` (flow rate matching)
- **Depends on:** `13_system_design/electrical_safety` (GFCI protection)
...
**Critic Verdict:** PASS
**Issues Addressed:**
- [Refugium Linkage]: Clarified the relationship between the 10x mandate and nutrient export efficiency.
- [Back-Siphon Safety]: Mandated siphon breaks/sump buffer as TIER 1 safety; prohibited check valves as a primary fail-safe.
- [Mounting Trade-offs]: Added internal vs. external mounting analysis regarding heat and leak risks.
- [Pump Types]: Defined pressure-rated vs. flow-rated pumps.
- [Maintenance]: Specified Citric Acid over vinegar to protect specialized seals.
