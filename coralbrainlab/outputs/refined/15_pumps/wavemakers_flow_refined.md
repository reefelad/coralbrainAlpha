...
## Interfaces
- **Connects to:** `13_system_design/flow_hydrodynamics` (theoretical targets)
...
**Critic Verdict:** PASS
**Issues Addressed:**
- [Invertebrate Safety]: Added TIER 1 mandate for pump guards to protect anemones and snails.
- [Optical Interaction]: Linked surface flow to Shimmer vs. Disco effects.
- [Emergency Priority]: Upgraded Battery Backup to a wavemaker-specific priority for life support.
- [Maintenance]: Added Gyre-specific cleaning warning.
- [Discovery First]: Enhanced discussion of DBL reduction as the metabolic engine of the reef.
