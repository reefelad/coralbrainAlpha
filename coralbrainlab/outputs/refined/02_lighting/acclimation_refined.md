...
**Issues Addressed:**
- **Navigation Footer:** Added mandatory navigation section.
- **Mesenterial Filaments:** Clarified that this signifies "extreme" shock in a light stress context.
- **Sandbed Buffering:** Emphasized as a primary TIER 2 recommendation for individual corals.
- **Polyp Retraction:** Added detail about retraction occurring specifically during peak daylight.
