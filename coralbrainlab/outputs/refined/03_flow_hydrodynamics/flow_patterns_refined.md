...
*   **Triton Linkage:** Turbulence in the display keeps detritus in suspension, which is essential for the Triton Method's high sump turnover (10x minimum) to effectively export that waste into the filtration system before it can break down into nutrients.
...
*   **Alternating/Reversible Gyre:** Modern gyre pumps allow for alternating directions, which prevents the "one-way" accumulation of detritus and provides a more natural, oscillating horizontal current.
...
- Previous: [Turnover & Volume Requirements](turnover_volume.md)
- Next: [Boundary Layers & Gas Exchange](boundary_layers.md)
...
- [Triton Alignment]: Explicitly linked display turbulence to high sump turnover for waste export.
- [Gyre Flow]: Added note about alternating/reversible gyre capabilities to improve detritus management.
