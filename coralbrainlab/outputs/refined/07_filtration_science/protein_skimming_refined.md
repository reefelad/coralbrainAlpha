...
*   **Venturi Cleaning:** Salt creep frequently forms in the air intake (venturi) where air and water mix. Blockage here drastically reduces air draw and bubble density. Check and clean monthly.
...
| :--- | :--- | :--- | :--- |
| **Air Draw** | ~300-800 LPH per 100 gallons | Varies by pump tech (AC vs DC); higher is generally better | [TIER-2] BRS Investigates |
| **Skimmer Pump Throughput** | 1.0 - 1.5x System Vol / Hour | Rate at which skimmer pump processes water (NOT sump flow) | [TIER-2] Manufacturer Specs |
...
*   **Ozone Safety:** If injecting ozone (O3) into the skimmer to boost performance, the air AND water effluent MUST be passed through activated carbon. Residual ozone is toxic to fish (gill damage) and humans (lung irritant if released into room).
...
*   **[VERIFY]** **Trace Element Stripping:** It is widely discussed that skimmers remove trace elements (e.g., Iodine, Manganese). This is likely due to these elements chelating to the hydrophobic amino acids that are removed, rather than direct removal of the ions themselves, but the exact proportions are debated.
...
**Critic Verdict:** PASS
**Issues Addressed:**
- **Water Turnover Clarification:** Renamed to "Skimmer Pump Throughput" and added note distinguishing it from sump flow to prevent confusion with Triton 10x rule.
- **Air Draw Range:** Widened to 300-800 LPH to reflect modern needle-wheel capabilities.
- **Venturi Maintenance:** Added specific subsection on cleaning air intake salt creep.
- **Trace Elements:** Expanded explanation to include chelation mechanism.
