...
## Interfaces
- **Connects to:** [05_coral_nutrition], [03_flow_hydrodynamics] (to keep particles suspended).
- **Depends on:** [03_flow_hydrodynamics] to ensure detritus reaches the overflow.
- **Informs:** [07_filtration_science] (specifically Protein Skimming subdomains).
...
- Next: [Biological Filtration Cycle](biological_filtration.md)
...
**Issues Addressed:**
- **Missing Navigation Footer:** Added standard navigation footer with correct relative paths.
- **Interface Links:** Updated placeholders to use specific domain/subdomain identifiers (e.g., 05_coral_nutrition, 03_flow_hydrodynamics).
- **Consistency:** Ensured consistent naming for the next subdomain (biological_filtration).
