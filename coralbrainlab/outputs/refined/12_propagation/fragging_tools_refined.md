...
| Flame Sterilization | Open flame (lighter) | 5-10 seconds | Scalpel blades, needles | For quick **between-coral** use only; not a substitute for primary disinfection |
...
⚠️ **Cyanoacrylate Safety:** Coral glue bonds skin instantly. Avoid direct contact. Keep acetone or debonding agent nearby in case of accidental skin adhesion [TIER-2: Common Practice].
...
**Critic Verdict:** PASS
**Issues Addressed:**
- [Cyanoacrylate Safety]: Added explicit safety note about skin bonding and acetone availability.
- [Flame Sterilization]: Clarified as "between-coral use only" in table notes.
