...
## Sources
*   [Tier 1] *Fish Disease: Diagnosis and Treatment* (Noga)
*   [Tier 2] Bulk Reef Supply (BRS) Quarantine Series
*   [Tier 2] Reef2Reef Fish Disease Forum Stickies (Humblefish et al.)
*   [Tier 3] Humblefish.com specific treatment guides
...
**Issues Addressed:**
- **Copper Ambiguity**: Explicitly split Copper into Chelated (2.5 ppm) and Ionic (0.5 ppm) with a critical lethal warning.
- **Navigation Footer**: Added standard navigation block.
- **Biomedia Seeding**: Added condition to only seed from disease-free displays.
