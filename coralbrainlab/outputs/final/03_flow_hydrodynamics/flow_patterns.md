...
*   **Triton Alignment:** Supports the "Stability over Numbers" principle by ensuring that no part of the system becomes a nutrient-trapping stagnant zone. Critically, turbulence keeps detritus in suspension long enough to be carried over the weir and into the sump, allowing the high-turnover filtration system to permanently export it.
...
*   **Reversibility:** Modern gyre pumps often feature reversible or alternating direction modes. Utilization of these modes is highly recommended to prevent "shadow zones" where detritus might otherwise settle in a single-direction flow regime.
...
## Interfaces
*   **Connects to:** [03_flow_hydrodynamics/turnover_volume](turnover_volume.md) (Pattern quality complements volume quantity)
*   **Depends on:** [15_pumps](../15_pumps/pump_technologies.md) (The mechanical capabilities of the hardware)
*   **Informs:** [03_flow_hydrodynamics/boundary_layers](boundary_layers.md) (Pattern directly dictates boundary layer thickness)

## Navigation
*   [**Prev: Turnover Volume**](turnover_volume.md)
*   [**Next: Boundary Layers**](boundary_layers.md)
*   [**Parent: Flow & Hydrodynamics**](../index.md)
