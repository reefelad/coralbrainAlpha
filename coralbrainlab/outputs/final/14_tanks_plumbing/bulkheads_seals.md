...
2. **Flash Removal:** Inspect the bulkhead model for "flashing" (excess plastic) and carefully remove it with a hobby knife to ensure the gasket seats perfectly.
...
## Interfaces
- **Connects to:** [14_tanks_plumbing/pipe_fittings](pipe_fittings.md) (NPT/Slip connections)
- **Connects to:** [14_tanks_plumbing/drilling_techniques](drilling_techniques.md) (hole sizing)
- **Depends on:** [14_tanks_plumbing/glass_acrylic](glass_acrylic.md) (material thickness compliance)
...
- Previous: [PVC Types & Fittings](pipe_fittings.md)
- Next: [Drilling Techniques](drilling_techniques.md)
