...
- **PO4 Stripping Rate:** Rapid removal of phosphate (e.g., from 0.40 ppm to 0.03 ppm in 24 hours) causes severe osmotic stress and **Rapid Tissue Necrosis (RTN)** in corals. When starting a reactor on a system with high nutrients, the flow should be minimal and ramp up over 10 days to allow for a slow, safe drop. [TIER-1]
