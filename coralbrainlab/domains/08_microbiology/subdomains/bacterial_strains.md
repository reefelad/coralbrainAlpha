...
- **Ammonia-Oxidizers**: Primarily *Nitrosomonas* and Ammonia-Oxidizing Archaea (AOA). They convert toxic ammonia ($NH_3$) into nitrite ($NO_2^-$). They are relatively slow-growing and surface-bound [TIER-1].
- **Nitrite-Oxidizers**: Historically credited to *Nitrobacter*, but modern DNA sequencing reveals *Nitrospira* species are often the dominant nitrite-oxidizers in established reef tanks, converting nitrite ($NO_2^-$) into nitrate ($NO_3^-$) [TIER-1].
- **Role**: They prevent acute toxicity. They live on surfaces (live rock, ceramic media) and form biofilm matrices. They do *not* live significantly in the water column, meaning UV sterilizers have little impact on established nitrifying populations.
...
- **Characteristics**: They reproduce exceptionally fast (doubling every 20-30 minutes) compared to nitrifiers (hours to days). Common genera include *Bacillus*, *Pseudomonas*, and *Vibrio* (though some Vibrio are pathogenic) [TIER-2].
...
- **Strains**: *Thiobacillus*, *Paracoccus*, and *Pseudomonas* species. Some are facultative anaerobes, meaning they can switch between oxygen and nitrate respiration [TIER-1].
...
### Probiotics and Coral Microbiome
Corals possess a surface mucopolysaccharide layer (mucus) that hosts a specific microbiome. 
- **Symbiosis**: Beneficial bacteria in coral mucus produce antibiotics to ward off pathogens and can even assist in nitrogen fixation for the coral [TIER-1].
- **Probiotic Dosing**: Adding specific strains (often *Bacillus* spores) is believed to outcompete potential pathogens (like *Vibrio coralliilyticus*) through competitive exclusion. **Note**: In the reef hobby, "probiotics" is often a catch-all marketing term encompassing both true probiotics (gut/health promoters) and heterotrophic sludge-consuming bacteria. While scientifically distinct, both are utilized to maintain dominance over pathogenic strains [TIER-2].

## Practical Application

### Establishing Diversity vs. Monoculture
- **Start-up**: Bottled bacteria products often contain a limited number of specific strains (e.g., just *Nitrosomonas*/*Nitrobacter* for cycling, or *Bacillus* for sludge).
...
- **"Old Tank Syndrome"**: This phenomenon is effectively a loss of biological stability over time. It is characterized by a gradual depletion of biodiversity (monoculture dominance) and often accompanied by the accumulation of refractory organic waste in hard-to-reach areas. This leaves the system vulnerable to a crash or pathogen takeover. Periodic introduction of new genetic material (live rock rubble, sand from healthy tanks) can mitigate this [TIER-3].
...
- **Connects to:** [07_Filtration -> Refugium Design] (Primary housing for bacterial populations)
...
## Gaps / Open Questions
- [GAP] Specific identification of "core microbiome" species for common *Acropora* in captivity vs wild.
...
- [TIER-1] Spotte, S. (1992). *Captive Seawater Fishes* (Nitrification science)
...
- Previous: [Cryptic Zones](../../07_filtration_science/subdomains/cryptic_zones.md)
- Next: [Carbon Dosing Dynamics](carbon_dosing.md)
