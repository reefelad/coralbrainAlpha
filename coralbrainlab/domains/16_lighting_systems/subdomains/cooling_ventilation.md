...
- **Informs:** `08_microbiology > bacterial_strains`
...
- Previous: [Mounting Arms & Suspension](mounting_solutions.md)
- Next: [Skimmer Sizing & Tuning](../../17_filtration_equipment/subdomains/skimmer_tuning.md)
